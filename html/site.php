        ...
        <div>
          <div class="card" id="resultsCard">
            ...
            <div id="results" style="margin-top:12px">
              <div class="empty">Aucune recherche lancée — utilisez le champ ci-dessus ou cliquez sur "Toutes les failles" à droite.</div>
            </div>
          </div>
          ...
          <div class="card" style="margin-top:12px">
            ...
            <ul class="small" style="margin:8px 0 0 18px;">
              <li>API de base : <code>http://localhost/api/failles</code></li>
              <li>Liste filtrée par IP : <code>/index.php?ip=ADRESSE_IP</code></li>
              <li>Toutes les failles : <code>/all.php</code></li>
              <li>Détail d’une faille : <code>/id.php?id=ID</code></li>
            </ul>
            <div class="small" style="margin-top:10px;color:var(--muted)">
              Le Java (scanner) remplit la BDD, et ce front consomme l’API PHP (qui lit dans la BDD).
            </div>
          </div>
        </div>
        ...
        return `
          <div style="padding:8px 0">
            ...
            <div style="margin-top:10px;background:#f8fafc;border-radius:8px;padding:10px;border:1px solid #eef2f5">
              ...
              <div class="small" style="margin-top:6px;color:var(--muted)">${detail.description ?? 'Aucune description fournie.'}</div>
            </div>
          </div>
        `;
      }
